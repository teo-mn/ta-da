      ...
      <div className="content">
          ...
          <div className=" py-6 flex flex-col text-gray-900">
            ...
            <div className="flex flex-row w-[100%] h-52 my-5">
              <div className="w-[50%]">
                ...
                <p className=" py-3 text-sm">
                  Body is primarily used for Spectrum components and for blocks
                  of text.
                </p>
                <p className="font-normal text-base text-blue-800">
            ...
            <div className="flex flex-row w-[100%] h-52 my-5">
              <div className="w-[50%]">
                ...
                <p className=" py-3 text-sm">
                  Detail is used for disclosing extra information or smaller
                  items in hierarchical relationships of text.
                </p>
                <p className="font-normal text-base text-blue-800">
          ...
          <div className="flex flex-col">
            <div className="flex flex-row my-5">
              ...
              <div className=" pl-8 w-[100%]">
                ...
                <p className="color-gray-900 font-normal font-s py-4">
                  ...
                  attention, for example, in buttons and toasts. It’s also used
                  to directly refer to the names of UI elements in running text.
                </p>
              </div>
            </div>
            <div className="flex flex-row my-5">
            ...
            <div className="flex flex-row my-5">
              ...
              <div className=" pl-8 w-[100%]">
                ...
                <p className="color-gray-900 font-normal font-s py-4">
                  ...
                  (either hover state or default state, depending on the style
                  of the link) and should never be used as a mechanism for
                  adding emphasis.
                </p>
              </div>
            </div>
            <div className="flex flex-row my-5">
              ...
              <div className=" pl-8 w-[100%]">
                ...
                <p className="color-gray-900 font-normal font-s py-4">
                  Strong can be used for placing importance on part of a
                  sentence, rendering the text as a heavier font weight. This is
                  for semantic formatting, when it’s intended to add a tone that
                  conveys importance.
                </p>
              </div>
            </div>
            <div className="flex flex-row my-5">
              ...
              <div className=" pl-8 w-[100%]">
                ...
                <p className="color-gray-900 font-normal font-s py-4">
                  Emphasis can be used for placing emphasis on part of a
                  sentence, rendering the text as italic (or heavier weight, in
                  CJK languages).
                </p>
              </div>
            </div>
        ...
        <div className="bg-white text-gray-700 py-6">
          ...
          <p className="text-gray-900 font-Manrope font-normal py-4">
            ...
            harmoniously, on both desktop and mobile. All font sizes have a
            ratio of 1.125, known as the major second type scale. This means
            that each size is multiplied or divided by 1.125 from the previous
            size, starting with the base size, and rounded. Custom text (any
